...
public class TestAllNews {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println( m.getStock(3).getStockHistory().getDailyStockHistory() );
		
		System.out.println("------Weekly Stock History---------");
		
		System.out.println( m.getStock(3).getStockHistory().getWeeklyStockHistory() );
		
		System.out.println("------Monthly Stock History---------");
		*/
		for(int i= 0 ; i < 10 ; i++) {
			System.out.println(m.getStock(i).getCompanyName());
			System.out.println( m.getStock(i).getStockHistory().getMonthlyStockHistory() );
			System.out.println(new MarketTime());
		}
		System.out.println(new MarketTime(18288000));
		/*
		System.out.println( m.getStock(3).getStockHistory().getDifference( new MarketTime( 120421801 ) , new MarketTime( 121672801 ) ));
