...
public class ChangePasswordPanel extends JPanel {
	...
	/** The password field 2. */
	private JPasswordField passwordField2;
	
	/** The added question warning. */
	boolean addedQuestionWarning;
	
	/** The added lbl passwords do not. */
	boolean addedLblPasswordsDoNot;
	
	/** The added lbl empty error. */
	boolean addedLblEmptyError;
	...
	public ChangePasswordPanel(JFrame frame) {
		...
		questionBox.addItem("Question1");
		questionBox.addItem("Question2");
		questionBox.addItem("Question3");
		questionBox.addItem("Question4");
		add(questionBox);
